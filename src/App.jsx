...
function App() {
  ...
  useEffect(() => {
    ...
    if (currentView === 'landing' && sectionId) {
  ...
  const openLanding = (sectionId) => {
    const hash = sectionId ? `#${sectionId}` : '#landing'
  ...
  if (currentView === 'studio') {
    return <StudioExperience onOpenLanding={openLanding} />
  }

  return <LandingPage onLaunchStudio={openStudio} onNavigate={openLanding} />
}
...
function getSectionFromHash() {
  ...
  return NAV_SECTIONS.some((section) => section.id === hash) ? hash : null
}

function LandingPage({ onLaunchStudio, onNavigate }) {
  return (
    <div className="app-shell landing-shell">
      ...
      <header className="topbar">
        ...
        <nav className="topnav">
          ...
          <button className="secondary-button" onClick={onLaunchStudio}>Launch studio</button>
        </nav>
      </header>
      ...
      <main className="landing-layout">
        <section className="landing-hero">
          <div className="landing-copy">
            ...
            <div className="hero-actions">
              <button className="primary-button" onClick={onLaunchStudio}>Launch the studio</button>
              <button className="ghost-button" onClick={() => onNavigate('how-it-works')}>See how it works</button>
            </div>
        ...
        <section className="landing-section cta-section">
          <div className="glass-card cta-card">
            ...
            <button className="primary-button" onClick={onLaunchStudio}>Launch AI Creative Studio</button>
          </div>
        </section>
      </main>
    </div>
...
function StudioExperience({ onOpenLanding }) {
  ...
  return (
    <div className="app-shell studio-shell">
      ...
      <header className="topbar studio-topbar">
        <button className="brand-mark" onClick={() => onOpenLanding()}>
          <span className="brand-orb" />
          <span>AI Creative Studio</span>
        </button>
        <nav className="topnav">
          <button className="nav-link" onClick={() => onOpenLanding()}>Landing</button>
          <button className="nav-link" onClick={() => onOpenLanding('how-it-works')}>How it works</button>
          <button className="nav-link" onClick={() => onOpenLanding('ai-loop')}>AI loop</button>
        </nav>
      </header>
